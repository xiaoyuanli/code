...
class SplunkProxy:
    ...
    # system index
    # __headers = {'Authorization': 'Splunk 91F62F8C-0E99-6F8C-A723-F8C8693AEFEF', 'Content-Type': 'application/json'}
    # test index:
    __headers = {'Authorization': 'Splunk 90E68F68-9EAF-8E65-9E88-361F65F265C1', 'Content-Type': 'application/json'}
    __cmd = "POST"
    __events = None
    ...
    def setTestMode( self ):
        self.setHeader('Authorization', 'Splunk 90F68F68-9EAF-6F65-9F88-361F65F265C1')
...
appsToMonitor = {'../lib/wrapper.jar:../lib/bamboo-agent-bootstrap.jar' : 'BambooAgent'}
appsToExclude = ['cd']
...
# Process disk stat
monitoredVolumes = ('/', '/home', '/mnt/releases')
dfLines = df.split('\n')
print "df lines:"
print dfLines
