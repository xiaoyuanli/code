...
class SplunkProxy:
    ...
    # system index
    __token = 'Splunk 91F82F6C-0E99-9F8C-A723-F8C8693AEFEF'
    __headers = {'Authorization': __token, 'Content-Type': 'application/json'}
    __cmd = "POST"
    __events = None
    ...
    def setTestMode( self ):
        self.setHeader('Authorization', 'Splunk 90A68F68-9EAF-8A65-9F66-391F65F265C1')
...
for row in vmLines:
    ...
    if (len(fields) == 3):
        ...
        val = int(fields[0]) / 1024
        vmStats[fieldname] = str(val)
